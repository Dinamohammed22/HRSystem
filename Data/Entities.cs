...
public class Entities : DbContext
{
    ...
    public DbSet<ProjectScrumMaster> ProjectScrumMasters { get; set; }
    ...
    public DbSet<CloseProject> CloseProjects { get; set; }
    public DbSet<ProjectCandidate> ProjectCandidates { get; set; }
    public DbSet<ProjectExternalMember> ProjectExternalMembers { get; set; }
